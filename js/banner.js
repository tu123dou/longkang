...
window.onload=function(){
	...
	logo.innerHTML='<a style="font-size: 30px;display: block;margin-top: 25px;" href="index.php.htm"  title="河北隆康玻璃钢有限公司"><h1 style="font-size: 30px">河北隆康玻璃钢有限公司</h1></a>';
	...
	leftcon.innerHTML=' <dl><dt>地址：</dt><dd>河北省衡水市枣强县城</dd></dl><dl><dt>王　超</dt><dd> 18831837229</dd><div class="clear"></div>'
